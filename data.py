...
class Edge:
    """
    Определяем ребро, как два связанных узла. Хранит информацию о ячейке слева и справа.
    """
...
class Grid:
    ...
    def get_vertex_edges(self, v_id):
        """
        Возвращает список индексов всех Рёбер, которым принадлежит узел с заданным индексом.
        Их порядок произвольный относительно узла.
        """
        edges = []
    ...
    def get_vertex_elements(self, v_id):
        """
        Возвращает список индексов всех Элементов, которым принадлежит узел с заданным индексом.
        Их порядок произвольный относительно узла.
        """
        elements = []
